...
public class ExplosionAppState extends AbstractAppState {
	...
	public void update(float tpf) {
		if (entities.applyChanges()) {
			removeEffects(entities.getRemovedEntities());
			addEffects(entities.getAddedEntities());
			updateEffects(entities.getChangedEntities());
		}
	}

	private void removeEffects(Set<Entity> entities) {
	...
	private void addEffects(Set<Entity> entities) {
	...
	private void updateEffects(Set<Entity> entities) {
		for (Entity e : entities) {
